//trying to make a crossway scnario where agents will start from fixed starting positions
...
*/
	...
	for(int i=0; i<agent_num; i++)
	{
		...
		if(i%2 == 0)
			{	
				temp_intial_x_val_l_right = intial_x_val_l_right;
				
				agent_pos[0] = temp_intial_x_val_l_right;
				agent_pos[1] = 14;
				
				intial_x_val_l_right = temp_intial_x_val_l_right + 0.9;
				
				//std::cout << "agent position for even: p[0] " << agent_pos[0] << " , " << "agent position: p[1] " << agent_pos[1] << std::endl;
				count1++;
			...
			{
				temp_intial_y_val_l_left = intial_y_val_l_left;
				agent_pos[0] = -20.0;
				agent_pos[1] = temp_intial_y_val_l_left;
				
				intial_y_val_l_left = temp_intial_y_val_l_left + 1.6;
				
				//std::cout << "agent position for odd: p[0] " << agent_pos[0] << " , " << "agent position: p[1] " << agent_pos[1] << std::endl;
				count2++;
			...
			if(c1%20==0)
			{
				intial_y_val_l_left = 3;
				intial_x_val_l_right = -14;
				break;
			}
		...
		*/
			...
			if(i%2 == 0)
			{
				...
				d_pos[0] = temp_intial_x_val_l_right;
				d_pos[1] = -14;
				
				intial_x_val_l_right = temp_intial_x_val_l_right + 0.9;
				
				//std::cout << "destination position for even: p[0] " << d_pos[0] << " , " << "destination position: p[1] " << d_pos[1] << std::endl;
			...
			{
				temp_intial_y_val_l_right = intial_y_val_l_right;
				d_pos[0] = 14.0;
				d_pos[1] = intial_y_val_l_right;
				
				intial_y_val_l_right = temp_intial_y_val_l_right + 1.6;
				
				//std::cout << "destination position for odd: p[0] " << d_pos[0] << " , " << "destination position: p[1] " << d_pos[1] << std::endl;
