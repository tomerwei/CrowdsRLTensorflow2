	...
	for(int i=0; i<agent_num; i++)
	{
		...
		if(i%2 == 0)
			{
				...
				intial_y_val_l_right = temp_intial_y_val_l_right + .7;
			...
			else
			{
				...
				intial_y_val_l_left = temp_intial_y_val_l_left + .7;
		...
		*/
			...
			if(i%2 == 0)
			{
				...
				intial_y_val_l_left = temp_intial_y_val_l_left + 0.55;
			...
			else
			{
				...
				intial_y_val_l_right = temp_intial_y_val_l_right + 0.55;
			...
			if(c2%14==0)
			{
				intial_y_val_l_right = -12;
				intial_y_val_l_left = -12;
				break;
			}
