	...
	for(int i=0; i<agent_num; i++)
	{
		...
		if(i%2 == 0)
			{
				...
				agent_pos[0] = 20.0;
				agent_pos[1] = temp_intial_y_val_l_right;
				
				intial_y_val_l_right = temp_intial_y_val_l_right + .9;
			...
			if(c1%20==0)
			{
				intial_y_val_l_left = -14;
				intial_y_val_l_right = temp_intial_y_val_l_right;
				temp_intial_y_val_l_left = 0;
				temp_intial_y_val_l_right =0;
				break;
			}
		...
		*/
			...
			if(i%2 == 0)
			{
				temp_intial_y_val_l_left = intial_y_val_l_left;
				d_pos[0] = -20.0;
				d_pos[1] = temp_intial_y_val_l_left;
				
				intial_y_val_l_left = temp_intial_y_val_l_left + 0.85 ;
			...
			else
			{
				...
				intial_y_val_l_right = temp_intial_y_val_l_right + 0.85 ;
